...
type Blip struct {
	...
	UserVote      *UserVoteStatus        `protobuf:"bytes,9,opt,name=user_vote,json=userVote,proto3,oneof" json:"user_vote,omitempty"` // Present if user is authenticated and has voted
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_blip_blip_proto_rawDesc = []byte{
	...
	0x74, 0x12, 0x39, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x08, 0x20,
	...
	0x75, 0x73, 0x65, 0x72, 0x5f, 0x76, 0x6f, 0x74, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32,
