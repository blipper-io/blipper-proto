...
type CreateBlipRequest struct {
	...
	ReblipOf      *int64                 `protobuf:"varint,5,opt,name=reblip_of,json=reblipOf,proto3,oneof" json:"reblip_of,omitempty"`
...
func (x *CreateBlipRequest) GetReblipOf() int64 {
...
type GetBlipRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            int64                  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"` // Snowflake ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetBlipRequest) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *DeleteBlipRequest) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *UpdateBlipRequest) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
type Blip struct {
	...
	ReblipOf      *int64                 `protobuf:"varint,6,opt,name=reblip_of,json=reblipOf,proto3,oneof" json:"reblip_of,omitempty"` // If this is a reblip
...
type Comment struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            int64                  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"` // Snowflake ID
	ParentBlipId  int64                  `protobuf:"varint,2,opt,name=parent_blip_id,json=parentBlipId,proto3" json:"parent_blip_id,omitempty"`
	Content       string                 `protobuf:"bytes,3,opt,name=content,proto3" json:"content,omitempty"`
...
func (x *Comment) GetParentBlipId() int64 {
	if x != nil {
...
type CreateCommentRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ParentBlipId  int64                  `protobuf:"varint,1,opt,name=parent_blip_id,json=parentBlipId,proto3" json:"parent_blip_id,omitempty"`
	Content       string                 `protobuf:"bytes,2,opt,name=content,proto3" json:"content,omitempty"`
	AuthorId      string                 `protobuf:"bytes,3,opt,name=author_id,json=authorId,proto3" json:"author_id,omitempty"`
	MediaUrls     []string               `protobuf:"bytes,4,rep,name=media_urls,json=mediaUrls,proto3" json:"media_urls,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *CreateCommentRequest) GetParentBlipId() int64 {
	if x != nil {
		return x.ParentBlipId
	}
	return 0
...
func (x *GetCommentsRequest) GetParentBlipId() int64 {
	if x != nil {
		return x.ParentBlipId
	}
	return 0
...
func (x *VoteRequest) GetTargetId() int64 {
	if x != nil {
		return x.TargetId
	}
	return 0
...
func (x *GetVoteStatusRequest) GetTargetId() int64 {
	if x != nil {
		return x.TargetId
	}
	return 0
...
var file_blip_blip_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x70, 0x5f, 0x6f, 0x66, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x48, 0x00, 0x52, 0x08,
	...
	0x66, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x48, 0x00, 0x52, 0x08, 0x72, 0x65, 0x62, 0x6c, 0x69,
	...
	0x70, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x70, 0x61, 0x72, 0x65,
	...
	0x03, 0x52, 0x0c, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x42, 0x6c, 0x69, 0x70, 0x49, 0x64, 0x12,
